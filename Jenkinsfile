...
node{
   ...
   /* stage ("check sock ")
    ...
    {
       ansiblePlaybook credentialsId: 'jenkinsansiblecred', disableHostKeyChecking: true, installation: 'ansible', inventory: 'hosts', playbook: 'ansible-playbook.yml', vaultTmpPath: ''
    }
}
